                                                        ...
                                                        <Card.Body>
                                                            ...
                                                            <h5 className="font-weight-bold"> {bankAccount.official_name} </h5>
																				 ...
																				 { this.state.bankAccounts.length == 0 ? (
																					 <div className="text-center">
																					 	<p className="lead">You haven't linked a bank account yet!</p>
																						 <Link to="/manage-banks"><Button className="font-weight-bold px-3 mb-3 btn btn-purple"><h6>+ Link A Bank Account</h6></Button></Link>
																						 <br />
																					 </div>
 				                                ) : (
																					<div className="text-center">
																						<Link to="/manage-banks"><Button className="font-weight-bold px-3 my-3 btn btn-purple"><h6>+ Link Another Bank Account</h6></Button></Link>
																						<br />
																					</div>
 				                                )}
                                    </Col>
